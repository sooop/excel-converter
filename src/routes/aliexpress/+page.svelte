<script>
	...
	import { aliexpressMapping } from '$lib/config/aliexpress.js';
	...
	async function handleFile(file) {
		...
		reader.onload = async (e) => {
			try {
				...
				// AliExpress 맵핑 설정 사용
				const convertedData = convertData(sourceData, aliexpressMapping);
...
<svelte:head>
	<title>Excel Converter - AliExpress</title>
</svelte:head>

<div class="converter-container">
	<h1>AliExpress - EXCEL CONVERTER</h1>
